    ...
    : QWizardPage(parent)
{
    ...
    qwidgetCtorRadioButton = new QRadioButton(tr("&QWidget-style constructor"));
    ...
    groupLayout->addWidget(qobjectCtorRadioButton);
    groupLayout->addWidget(qwidgetCtorRadioButton);
    groupLayout->addWidget(defaultCtorRadioButton);
    groupLayout->addWidget(copyCtorCheckBox);
    ...
    : QWizardPage(parent)
{
    ...
    includeBaseCheckBox = new QCheckBox(tr("&Include base class defintion"));
